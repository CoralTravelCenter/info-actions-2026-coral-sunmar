// DEV: этот файл подключается в scripts/info-actions.js.
// Перед production-сборкой импорт нужно закомментировать: на сайте
// window._promotion_settings заполняет внешний скрипт.
